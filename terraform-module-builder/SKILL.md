...
description: >-
  ...
  migration safety, and module validation; do not use for Terraform apply.
---
...
any remaining replacement or destruction risk. Do not run apply, destroy, or state
commands without an explicit request.
